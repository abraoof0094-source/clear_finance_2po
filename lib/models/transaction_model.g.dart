...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'categoryBucket': PropertySchema(
      ...
      enumMap: _TransactionModelcategoryBucketEnumValueMap,
    ),
...
int _transactionModelEstimateSize(
  ...
  bytesCount += 3 + object.categoryBucket.name.length * 3;
...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[1], object.categoryBucket.name);
...
TransactionModel _transactionModelDeserialize(
  ...
  final object = TransactionModel(
    ...
    categoryBucket: _TransactionModelcategoryBucketValueEnumMap[
            reader.readStringOrNull(offsets[1])] ??
        CategoryBucket.income,
    categoryIcon: reader.readStringOrNull(offsets[2]) ?? '📝',
    categoryId: reader.readLongOrNull(offsets[3]),
    categoryName: reader.readString(offsets[4]),
    date: reader.readDateTime(offsets[5]),
    id: reader.readLong(offsets[6]),
    isarId: id,
    note: reader.readStringOrNull(offsets[7]),
    recurringRuleId: reader.readLongOrNull(offsets[8]),
    type: _TransactionModeltypeValueEnumMap[
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_TransactionModelcategoryBucketValueEnumMap[
...
const _TransactionModelcategoryBucketEnumValueMap = {
  r'income': r'income',
  r'expense': r'expense',
  r'invest': r'invest',
  r'liability': r'liability',
  r'goal': r'goal',
};
const _TransactionModelcategoryBucketValueEnumMap = {
  r'income': CategoryBucket.income,
  r'expense': CategoryBucket.expense,
  r'invest': CategoryBucket.invest,
  r'liability': CategoryBucket.liability,
  r'goal': CategoryBucket.goal,
};
...
const _TransactionModeltypeValueEnumMap = {
  ...
  r'investment': TransactionType.investment,
};
...
extension TransactionModelByIndex on IsarCollection<TransactionModel> {
  ...
  TransactionModel? getByIdSync(int id) {
  ...
  Future<List<TransactionModel?>> getAllById(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<TransactionModel?> getAllByIdSync(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      categoryBucketContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      categoryBucketMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByCategoryBucket({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, CategoryBucket, QQueryOperations>
