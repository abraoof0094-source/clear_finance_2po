...
const CategoryModelSchema = CollectionSchema(
  ...
  properties: {
    r'bucket': PropertySchema(
      ...
      name: r'bucket',
      type: IsarType.byte,
      enumMap: _CategoryModelbucketEnumValueMap,
    ),
    ...
    r'monthlyMandate': PropertySchema(
      id: 6,
      name: r'monthlyMandate',
...
void _categoryModelSerialize(
  ...
  writer.writeByte(offsets[0], object.bucket.index);
  writer.writeString(offsets[1], object.icon);
  writer.writeLong(offsets[2], object.id);
  writer.writeBool(offsets[3], object.isDefault);
  writer.writeBool(offsets[4], object.isMandate);
  writer.writeBool(offsets[5], object.isPinned);
  writer.writeDouble(offsets[6], object.monthlyMandate);
...
P _categoryModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_CategoryModelbucketValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _CategoryModelbucketEnumValueMap = {
  'income': 0,
  'expense': 1,
  'invest': 2,
  'liability': 3,
...
const _CategoryModelbucketValueEnumMap = {
...
extension CategoryModelByIndex on IsarCollection<CategoryModel> {
  ...
  CategoryModel? getByIdSync(int id) {
  ...
  Future<List<CategoryModel?>> getAllById(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<CategoryModel?> getAllByIdSync(List<int> idValues) {
    final values = idValues.map((e) => [e]).toList();
...
extension CategoryModelQueryFilter
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      bucketEqualTo(CategoryBucket value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      isMandateEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isMandate',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      monthlyMandateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'monthlyMandate',
      ));
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      monthlyMandateIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByBucket() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucket', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByBucketDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByIsMandate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMandate', Sort.asc);
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByIsMandateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMandate', Sort.desc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByIsPinned() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByMonthlyMandate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyMandate', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy>
      sortByMonthlyMandateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyMandate', Sort.desc);
    });
  }
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByBucket() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucket', Sort.asc);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByBucketDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bucket', Sort.desc);
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByIsMandate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isMandate', Sort.asc);
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByIsPinned() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isPinned', Sort.asc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByBucket() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'bucket');
    });
  }
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByIsMandate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isMandate');
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByIsPinned() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct>
      distinctByMonthlyMandate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'monthlyMandate');
    });
  }
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, CategoryBucket, QQueryOperations>
      bucketProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, bool, QQueryOperations> isMandateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isMandate');
    });
  }

  QueryBuilder<CategoryModel, bool, QQueryOperations> isPinnedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, double?, QQueryOperations>
      monthlyMandateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'monthlyMandate');
    });
  }
